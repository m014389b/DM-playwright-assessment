...
import { fullYearLeaveAnnualised_calculatedEntitlement_content, common_calculatedEntitlement_content } from "../content/calculatedEntitlement_content";
...
class CalculatedEntitlementPage {
    ...
    async checkFullYearLeaveAnnualisedPageLoads(page: Page): Promise<void> {
        await Promise.all([
            ...
            expect(page.locator(this.text)).toContainText(fullYearLeaveAnnualised_calculatedEntitlement_content.rulesText),
            ...
            expect(page.locator(this.text)).toContainText(fullYearLeaveAnnualised_calculatedEntitlement_content.employerListText4),
...
//             expect(page.locator('a', { hasText: common_calculatedEntitlement_content.calculatorHomePageLinkText })).toHaveAttribute('href', "/calculate-your-holiday-entitlement" ),
